...
Three more variables "stage_rotation", "stage_x_cor" and "stage_y_cor" needs to be defined to incorporate with the user's stage coordinate and direction that images are taken. Detail instruction on setting these variables can be found in "Muscle_data_analysis.ipynb" under the section of creating combined image
...
ma.pks_from_img.combined_image(path_smFRET,red_x_start,red_x_end,red_y_start,red_y_end,green_x_start,green_x_end,green_y_start,green_y_end, POS, ALEX, tr_R2G, apriori_tr_original, stage_rotation, stage_x_cor, stage_y_cor,tr) #create combined image
...
Note that variables "stage_rotation", "stage_x_cor" and "stage_y_cor" should also be defined as if you run a full cycle, although you may already have a separate combined image and you want to use this function separately
rb_rad, r = ma.align.alignment(path_smFRET,red_x_start,red_x_end,red_y_start,red_y_end,green_x_start,green_x_end,green_y_start,green_y_end,POS, ALEX, tr_R2G, apriori_tr, x_coord, y_coord, sequence, read2,stage_rotation,stage_x_cor,stage_y_cor, tr) #main cycle
